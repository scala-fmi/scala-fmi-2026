...
import fmi.user.{RegistrationFormError, UserLogin, UserRegistrationForm, UserRole}
import sttp.model.StatusCode.{BadRequest, Conflict, Forbidden, Unauthorized}
import sttp.tapir.*
import sttp.tapir.json.circe.*
import io.circe.Codec

transparent sealed trait HttpError
sealed transparent trait AuthenticationError extends HttpError
...
case class NotEnoughStock(message: String, n: Int) derives Codec, Schema
