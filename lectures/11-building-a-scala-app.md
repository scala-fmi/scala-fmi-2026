...
* Днес и следващата ще опитаме да изградим цялостно конкретно приложение
    - Функционално
...
* [ZIO](https://zio.dev/)
* [Kyo](https://getkyo.io/#/?id=introduction)
* [Monix Task](https://monix.io/docs/current/eval/task.html)
* Future

::: { .fragment }

Всички без Future предоставят имплементация на Cats Effect type class-овете
...
* Да видим как да постигнем безопасност чрез Resource
...
* [http4s](https://http4s.org/) - based on cats-effect and fs2 (streaming). Provides an API that can work over various HTTP implementations
...
* [tapir](https://tapir.softwaremill.com) – описване на endpoint-и като данни. Endpoint-ите могат да бъдат интерпретирани към различни сървър и клиентски имплементации
* [sttp](https://sttp.softwaremill.com) – API за клиентски HTTP. Може да се свърже с различни имплементации на HTTP клиент
